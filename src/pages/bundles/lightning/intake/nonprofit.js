...
import NPStakes from '../../../../components/intake/NPStakes'
import NPResolution from '../../../../components/intake/NPResolution'
...
export default function NonprofitIntake() {
        ...
        <FlexContainer>
          <FormContainer>
            ...
            >
              ...
              <input type="hidden" name="form-name" value="intake-nonprofit" />
              <Slider>
                <InnerSlider>
                  {slides.map((slide, i) => (
                    <NodeParser
